...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden h-screen w-64 shrink-0 flex-col border-r border-white/10 bg-navy-700 text-white lg:flex">
      {/* Logo */}
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              ...
              {/* Crown badge on Settings for superadmins — signals admin management is available */}
